    ...
    if cnts != ():
        ...
        for i in cnts:
            ...
            for idx in range(len(approx)):
                x_offset = approx[i][0][0] * pixel_length_ratio
                y_offset = approx[i][0][1] * pixel_length_ratio
                ...
                block_point = f"{300.00+arm_x_offset}, {410+arm_y_offset}, 225, -180.00, 0.0, {final_angle}"
            ...
            j = j + 1
            up = f"{270.00+arm_x_offset}, {290+arm_y_offset}, 240, -180.00, 0.0, {final_angle}"
